...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Úte 28. bře 2023, 14:42
...
-- Databáze: `krmeni`
--
CREATE DATABASE IF NOT EXISTS `krmeni` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
USE `krmeni`;
--
-- Databáze: `mp_svoboda`
--
CREATE DATABASE IF NOT EXISTS `mp_svoboda` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `mp_svoboda`;
...
CREATE TABLE `action` (
  `id` int(11) NOT NULL,
  `kaliDone` int(11) NOT NULL DEFAULT 0,
  `pourWatter` int(11) NOT NULL DEFAULT 0,
  `pourFood` int(11) NOT NULL DEFAULT 0
...
CREATE TABLE `animal` (
  `id` int(11) NOT NULL,
  `valueFood` int(11) NOT NULL DEFAULT 0,
  `valueWatter` int(11) NOT NULL DEFAULT 0,
...
('c4733fa3-5933-4592-a32a-d48e96371099', '926b5d6765e29b3473392dfb5a6245a3dc60e4882da773e1f0bae992471b7700', '2023-03-25 15:51:12.836', '20230325155112_update', NULL, NULL, '2023-03-25 15:51:12.802', 1);
...
('root', '[{\"db\":\"ffff\",\"table\":\"akce\"},{\"db\":\"ffff\",\"table\":\"cat\"},{\"db\":\"ffff\",\"table\":\"animal\"},{\"db\":\"krmeni\",\"table\":\"udaje\"},{\"db\":\"krmeni\",\"table\":\"Udaje\"}]');
...
('root', '2023-03-28 12:41:02', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"cs\"}');
